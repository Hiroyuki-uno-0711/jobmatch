  ...
  def general_affairs
    ...
    case current_user.career
     when '有形営業', '無形営業', '物流倉庫管理', '一般事務', '商品サービス企画', '経理', '人事', 'システムエンジニア', '販売サービス'
      @memo = '総務は、企業活動および社員の就労環境を物心両面から支える仕事です。具体的には、オフィスや什器、調度の手配、社内規則整備、社内文書管理、株式関係業務、福利厚生制度の整備、職場環境整備、業務改善の推進、社内プロジェクト推進など様々です。総務は企業内情に詳しい人材が重宝されやすいためため、内部から人材を採用するケースが多く、中途募集はあまり多くない現状です。専門スキルも問われるため総じて転職ハードルは高い職種となります。'
